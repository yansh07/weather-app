...
function Hero() {
  ...
  return (
    <div className="flex flex-row items-center gap-16 p-2 px-8 md:gap-44 md:px-2 lg:px-32 xl:gap-96 xl:ml-10 lg:gap-48">
      ...
      <div className="flex gap-3 px-2 text-xs md:text-sm md:pt-4 xl:text-lg xl:px-92 xl:px-8 text-gray-300/90 font-heading">
